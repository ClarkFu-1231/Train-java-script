...
A zoomable candlestick chart with several features.
    ...
    3. Draggable/Zoomable on the x-axis, with post-zoom y-axis adjustment based on no zoom events for 0.5 seconds, 
    after which the y-axis adjusts with a smooth transition.
*/ 
function drawChart() {

	d3.csv("GOOG.csv").then(function(prices) {
